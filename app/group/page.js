...
const GroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `https://abc-delta-two.vercel.app/api/menu/${selectedMainCategory}/assignmenus`,
        {
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `https://abc-delta-two.vercel.app/api/main/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://abc-delta-two.vercel.app/api/menu/${selectedMainCategory}/removemenus`,
        {
