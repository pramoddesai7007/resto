...
const GSTForm = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://abc-delta-two.vercel.app/api/gst/gst/${deletingItemId}`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('https://abc-delta-two.vercel.app/api/gst/create', { gstPercentage });
      fetchGSTList();
      setGSTPercentage('');
    } catch (error) {
