...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('https://abc-delta-two.vercel.app/api/greet/greet');
  ...
  const deleteGreet = async (greetId) => {
    try {
      const response = await axios.delete(`https://abc-delta-two.vercel.app/api/greet/greet/${greetId}`);
  ...
  const createGreet = async () => {
    ...
    try {
      const response = await axios.post('https://abc-delta-two.vercel.app/api/greet/greet', createGreetData);
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`https://abc-delta-two.vercel.app/api/greet/greet/${greetId}`, updateGreetData);
